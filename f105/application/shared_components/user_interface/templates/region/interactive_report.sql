...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10085082180138718)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10085312624138718)
,p_plug_template_id=>wwv_flow_imp.id(10085082180138718)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10085658360138718)
,p_plug_template_id=>wwv_flow_imp.id(10085082180138718)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10085986846138718)
,p_plug_template_id=>wwv_flow_imp.id(10085082180138718)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10086289086138718)
,p_plug_template_id=>wwv_flow_imp.id(10085082180138718)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10086561750138718)
,p_plug_template_id=>wwv_flow_imp.id(10085082180138718)
,p_name=>'Sub Regions'
