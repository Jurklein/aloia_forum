...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10035950444138694)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10036289711138694)
,p_plug_template_id=>wwv_flow_imp.id(10035950444138694)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10036507820138694)
,p_plug_template_id=>wwv_flow_imp.id(10035950444138694)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10036831695138694)
,p_plug_template_id=>wwv_flow_imp.id(10035950444138694)
,p_name=>'Sub Regions'
