...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10057279565138704)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10057539966138704)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10057835646138705)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10058177088138705)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10058471289138705)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10058730763138705)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10059084476138705)
,p_plug_template_id=>wwv_flow_imp.id(10057279565138704)
,p_name=>'Sub Regions'
