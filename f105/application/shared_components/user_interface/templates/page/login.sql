...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10003575251138674)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10003817100138674)
,p_page_template_id=>wwv_flow_imp.id(10003575251138674)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10004181353138674)
,p_page_template_id=>wwv_flow_imp.id(10003575251138674)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10004496275138674)
,p_page_template_id=>wwv_flow_imp.id(10003575251138674)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10004740349138674)
,p_page_template_id=>wwv_flow_imp.id(10003575251138674)
,p_name=>'Body Footer'
