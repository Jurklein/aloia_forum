...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18411340656105245)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18411622234105245)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18411997524105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18412228241105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18412524145105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18412892015105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18413193216105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18413427037105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18413790527105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18414017994105246)
,p_plug_template_id=>wwv_flow_imp.id(18411340656105245)
,p_name=>'Sub Regions'
