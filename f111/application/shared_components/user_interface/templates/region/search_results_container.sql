...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18386965699105234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18387268576105234)
,p_plug_template_id=>wwv_flow_imp.id(18386965699105234)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18387526387105234)
,p_plug_template_id=>wwv_flow_imp.id(18386965699105234)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18387807276105235)
,p_plug_template_id=>wwv_flow_imp.id(18386965699105234)
,p_name=>'Sub Regions'
