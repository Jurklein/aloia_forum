...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18648766530106282)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(18649514020106283)
,p_name=>'Manage User Access'
...
,p_owner=>'JURKLEIN'
,p_internal_uid=>18649514020106283
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18649947639106286)
,p_db_column_name=>'ID'
,p_display_order=>0
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18650370295106287)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(18650762829106287)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(18652392782106289)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'186524'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18653245983106289)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(18648766530106282)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18653613081106290)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18654004430106290)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18648887673106282)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(18648766530106282)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18654609582106290)
,p_event_id=>wwv_flow_imp.id(18648887673106282)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(18648766530106282)
);
