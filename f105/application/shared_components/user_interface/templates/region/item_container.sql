...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10087194837138719)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10087441655138719)
,p_plug_template_id=>wwv_flow_imp.id(10087194837138719)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10087751952138719)
,p_plug_template_id=>wwv_flow_imp.id(10087194837138719)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10088009691138719)
,p_plug_template_id=>wwv_flow_imp.id(10087194837138719)
,p_name=>'Button Start'
