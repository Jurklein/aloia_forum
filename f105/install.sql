...
@@workspace/credentials/credentials_for_test.sql
@@workspace/credentials/vddev.sql
@@workspace/credentials/vdhom_oa2.sql
@@workspace/remote_servers/test.sql
@@workspace/remote_servers/g7903ed2f95e81b_vddev_adb_eu_madrid_1_oraclecloudapps_com_ords_vddev.sql
@@workspace/remote_servers/g7903ed2f95e81b_vddev_adb_eu_madrid_1_oraclecloudapps_com_ords_vddev_2.sql
@@workspace/remote_servers/g7903ed2f95e81b_vddev_adb_eu_madrid_1_oraclecloudapps_com_ords_vdhom.sql
@@workspace/remote_servers/g7903ed2f95e81b_vddev_adb_eu_madrid_1_oraclecloudapps_com_ords_vdhom_2.sql
@@application/shared_components/data_profiles/vddev_apps.sql
@@application/shared_components/data_profiles/vdhom_apps.sql
@@application/shared_components/web_sources/vddev_apps.sql
@@application/shared_components/web_sources/vdhom_apps.sql
...
@@application/shared_components/user_interface/lovs/deploy_admin_lov.sql
@@application/shared_components/user_interface/lovs/vddev_apps_lov.sql
@@application/shared_components/user_interface/lovs/vdhom_apps_lov.sql
...
@@application/deployment/install/install_table_deploy_admin.sql
@@application/deployment/install/install_error_proxy.sql
@@application/deployment/install/install_string_proxy.sql
@@application/deployment/install/install_log_dbg.sql
@@application/deployment/install/install_workspace_apps_select_list.sql
@@application/deployment/install/install_apex_apps_rest.sql
@@application/deployment/install/install_apex_apps_expimp_ords_service.sql
