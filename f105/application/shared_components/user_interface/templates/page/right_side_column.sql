...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10015066727138680)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10015305841138680)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10015662073138680)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10015980486138680)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10016214111138680)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10016573083138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10016832041138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10017133195138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10017429776138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10017700820138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10018053716138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10018328966138681)
,p_page_template_id=>wwv_flow_imp.id(10015066727138680)
