...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18324313978105189)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18324666056105192)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18324994378105192)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18325295977105192)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18325518216105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18325826962105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18326145005105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18326421804105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18326786410105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18327033988105193)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18327319232105194)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18327683439105194)
,p_page_template_id=>wwv_flow_imp.id(18324313978105189)
