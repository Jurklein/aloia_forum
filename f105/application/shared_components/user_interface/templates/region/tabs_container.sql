...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10104693750138727)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10104948174138727)
,p_plug_template_id=>wwv_flow_imp.id(10104693750138727)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10105233342138727)
,p_plug_template_id=>wwv_flow_imp.id(10104693750138727)
,p_name=>'Tabs'
