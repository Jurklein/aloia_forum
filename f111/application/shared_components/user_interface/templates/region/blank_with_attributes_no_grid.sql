...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18358781790105219)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18359070167105219)
,p_plug_template_id=>wwv_flow_imp.id(18358781790105219)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18359343387105220)
,p_plug_template_id=>wwv_flow_imp.id(18358781790105219)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18359630705105220)
,p_plug_template_id=>wwv_flow_imp.id(18358781790105219)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18359950245105220)
,p_plug_template_id=>wwv_flow_imp.id(18358781790105219)
,p_name=>'Sub Regions'
