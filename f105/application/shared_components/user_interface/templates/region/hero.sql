...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10061826024138706)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10062113598138707)
,p_plug_template_id=>wwv_flow_imp.id(10061826024138706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10062433989138707)
,p_plug_template_id=>wwv_flow_imp.id(10061826024138706)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10062771801138707)
,p_plug_template_id=>wwv_flow_imp.id(10061826024138706)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10063096609138707)
,p_plug_template_id=>wwv_flow_imp.id(10061826024138706)
,p_name=>'Sub Regions'
