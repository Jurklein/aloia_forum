...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10065066769138708)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10065330639138708)
,p_plug_template_id=>wwv_flow_imp.id(10065066769138708)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10065662788138709)
,p_plug_template_id=>wwv_flow_imp.id(10065066769138708)
,p_name=>'Sub Regions'
