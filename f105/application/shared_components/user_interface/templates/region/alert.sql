...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10023654866138684)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10023917082138687)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10024278441138687)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10024507274138687)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10024833275138687)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10025162625138688)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10025482892138688)
,p_plug_template_id=>wwv_flow_imp.id(10023654866138684)
,p_name=>'Sub Regions'
