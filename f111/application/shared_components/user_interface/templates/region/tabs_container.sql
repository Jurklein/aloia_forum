...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18399447965105240)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18399722989105240)
,p_plug_template_id=>wwv_flow_imp.id(18399447965105240)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18400051182105240)
,p_plug_template_id=>wwv_flow_imp.id(18399447965105240)
,p_name=>'Tabs'
