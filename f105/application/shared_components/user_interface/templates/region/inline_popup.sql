...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10079666859138715)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10079915908138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10080201567138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10080529850138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10080892515138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10081145375138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10081432696138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10081796520138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10082058227138716)
,p_plug_template_id=>wwv_flow_imp.id(10079666859138715)
,p_name=>'Sub Regions'
