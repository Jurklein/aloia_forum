...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18420845409105251)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18421122691105251)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18421411481105252)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18421788484105252)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18422022246105252)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18422377446105252)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18422666716105252)
,p_plug_template_id=>wwv_flow_imp.id(18420845409105251)
,p_name=>'Sub Regions'
