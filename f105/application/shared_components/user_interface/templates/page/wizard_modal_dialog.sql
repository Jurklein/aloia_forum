...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10022195977138683)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10022495506138683)
,p_page_template_id=>wwv_flow_imp.id(10022195977138683)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10022707230138683)
,p_page_template_id=>wwv_flow_imp.id(10022195977138683)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10023011988138684)
,p_page_template_id=>wwv_flow_imp.id(10022195977138683)
