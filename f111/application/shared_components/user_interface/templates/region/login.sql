...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18432600460105257)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18432923547105258)
,p_plug_template_id=>wwv_flow_imp.id(18432600460105257)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18433254904105258)
,p_plug_template_id=>wwv_flow_imp.id(18432600460105257)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18433567072105258)
,p_plug_template_id=>wwv_flow_imp.id(18432600460105257)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18433855554105258)
,p_plug_template_id=>wwv_flow_imp.id(18432600460105257)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18434198923105258)
,p_plug_template_id=>wwv_flow_imp.id(18432600460105257)
,p_name=>'Sub Regions'
