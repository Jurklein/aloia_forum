...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10070413826138711)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10070728634138711)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10071077287138711)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10071308292138711)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10071688669138711)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10071907728138712)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10072241979138712)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10072526374138712)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10072842447138712)
,p_plug_template_id=>wwv_flow_imp.id(10070413826138711)
,p_name=>'Sub Regions'
