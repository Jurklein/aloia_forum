...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18360168825105220)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18360444647105220)
,p_plug_template_id=>wwv_flow_imp.id(18360168825105220)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18360718244105220)
,p_plug_template_id=>wwv_flow_imp.id(18360168825105220)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18361055571105220)
,p_plug_template_id=>wwv_flow_imp.id(18360168825105220)
,p_name=>'Sub Regions'
