...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10018748841138682)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10019046721138682)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10019318412138682)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10019637516138682)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10019991939138682)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10020203325138682)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10020538596138683)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10020854409138683)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10021102950138683)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10021493234138683)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10021712654138683)
,p_page_template_id=>wwv_flow_imp.id(10018748841138682)
