...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10089643441138720)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10089970720138720)
,p_plug_template_id=>wwv_flow_imp.id(10089643441138720)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10090205050138720)
,p_plug_template_id=>wwv_flow_imp.id(10089643441138720)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10090569525138720)
,p_plug_template_id=>wwv_flow_imp.id(10089643441138720)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10090896723138720)
,p_plug_template_id=>wwv_flow_imp.id(10089643441138720)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10091117731138720)
,p_plug_template_id=>wwv_flow_imp.id(10089643441138720)
,p_name=>'Sub Regions'
