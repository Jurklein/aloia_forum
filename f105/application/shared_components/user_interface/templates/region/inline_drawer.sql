...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10075042627138713)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10075395428138713)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10075616498138713)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10075939310138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10076279429138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10076533058138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10076839462138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10077154190138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10077450706138714)
,p_plug_template_id=>wwv_flow_imp.id(10075042627138713)
,p_name=>'Sub Regions'
