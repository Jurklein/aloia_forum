...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9995878256138670)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9996121354138670)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9996493198138670)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9996762702138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9997094407138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9997342752138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9997673226138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9997915984138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9998242810138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9998565924138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9998891758138671)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9999117611138672)
,p_page_template_id=>wwv_flow_imp.id(9995878256138670)
