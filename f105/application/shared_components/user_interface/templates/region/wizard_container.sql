...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10112031079138730)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10112341660138731)
,p_plug_template_id=>wwv_flow_imp.id(10112031079138730)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10112648278138731)
,p_plug_template_id=>wwv_flow_imp.id(10112031079138730)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10112920424138731)
,p_plug_template_id=>wwv_flow_imp.id(10112031079138730)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10113241092138731)
,p_plug_template_id=>wwv_flow_imp.id(10112031079138730)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10113563728138731)
,p_plug_template_id=>wwv_flow_imp.id(10112031079138730)
