...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18347229699105204)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18347510964105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18347860140105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18348185095105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18348476022105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18348702137105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18349082764105205)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18349330200105206)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18349615051105206)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18349993309105206)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18350237599105206)
,p_page_template_id=>wwv_flow_imp.id(18347229699105204)
