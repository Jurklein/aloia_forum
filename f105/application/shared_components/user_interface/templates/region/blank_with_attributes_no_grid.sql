...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10030206528138691)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10030570207138691)
,p_plug_template_id=>wwv_flow_imp.id(10030206528138691)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10030880181138691)
,p_plug_template_id=>wwv_flow_imp.id(10030206528138691)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10031124833138691)
,p_plug_template_id=>wwv_flow_imp.id(10030206528138691)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10031477824138692)
,p_plug_template_id=>wwv_flow_imp.id(10030206528138691)
,p_name=>'Sub Regions'
