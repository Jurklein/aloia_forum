...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10010138502138677)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10010436048138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10010749052138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10011055477138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10011367777138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10011657001138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10011984663138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10012253435138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10012582479138678)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10012898694138679)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10013100854138679)
,p_page_template_id=>wwv_flow_imp.id(10010138502138677)
