...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18338625821105200)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18338959611105200)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18339222038105200)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18339506800105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18339897743105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18340111246105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18340461450105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18340755591105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18341082701105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18341332158105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18341607889105201)
,p_page_template_id=>wwv_flow_imp.id(18338625821105200)
