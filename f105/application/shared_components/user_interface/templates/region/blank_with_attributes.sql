...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10028819693138690)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10029187007138690)
,p_plug_template_id=>wwv_flow_imp.id(10028819693138690)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10029458340138691)
,p_plug_template_id=>wwv_flow_imp.id(10028819693138690)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10029747785138691)
,p_plug_template_id=>wwv_flow_imp.id(10028819693138690)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10030022389138691)
,p_plug_template_id=>wwv_flow_imp.id(10028819693138690)
,p_name=>'Sub Regions'
