...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18429447266105255)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18429751113105256)
,p_plug_template_id=>wwv_flow_imp.id(18429447266105255)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18430027450105256)
,p_plug_template_id=>wwv_flow_imp.id(18429447266105255)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18430323916105256)
,p_plug_template_id=>wwv_flow_imp.id(18429447266105255)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18430609376105257)
,p_plug_template_id=>wwv_flow_imp.id(18429447266105255)
,p_name=>'Sub Regions'
