...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10047719474138700)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10048098856138700)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10048337523138700)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10048653473138700)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10048987170138700)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10049232322138701)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10049550086138701)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10049849650138701)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10050187640138701)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10050400525138701)
,p_plug_template_id=>wwv_flow_imp.id(10047719474138700)
,p_name=>'Sub Regions'
