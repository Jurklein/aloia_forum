...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18377558482105230)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18377874669105230)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18378195365105230)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18378403915105230)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18378764749105231)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18379012120105231)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18379309159105231)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18379681267105231)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18379927008105231)
,p_plug_template_id=>wwv_flow_imp.id(18377558482105230)
,p_name=>'Sub Regions'
