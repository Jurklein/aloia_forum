...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10092139630138721)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10092487888138721)
,p_plug_template_id=>wwv_flow_imp.id(10092139630138721)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10092729431138721)
,p_plug_template_id=>wwv_flow_imp.id(10092139630138721)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10093098331138721)
,p_plug_template_id=>wwv_flow_imp.id(10092139630138721)
,p_name=>'Sub Regions'
