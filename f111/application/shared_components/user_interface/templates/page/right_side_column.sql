...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18343513169105202)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18343843665105203)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18344116047105203)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18344460477105203)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18344702485105203)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345082429105203)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345339950105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345677383105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345940526105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18346270306105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18346543597105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18346864345105204)
,p_page_template_id=>wwv_flow_imp.id(18343513169105202)
