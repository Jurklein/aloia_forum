...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18332079528105197)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18332343161105197)
,p_page_template_id=>wwv_flow_imp.id(18332079528105197)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18332685715105197)
,p_page_template_id=>wwv_flow_imp.id(18332079528105197)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18332958834105197)
,p_page_template_id=>wwv_flow_imp.id(18332079528105197)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18333219627105197)
,p_page_template_id=>wwv_flow_imp.id(18332079528105197)
,p_name=>'Body Footer'
