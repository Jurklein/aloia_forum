...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18384409005105233)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18384708982105233)
,p_plug_template_id=>wwv_flow_imp.id(18384409005105233)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18385056458105233)
,p_plug_template_id=>wwv_flow_imp.id(18384409005105233)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18385303134105233)
,p_plug_template_id=>wwv_flow_imp.id(18384409005105233)
,p_name=>'Button Start'
